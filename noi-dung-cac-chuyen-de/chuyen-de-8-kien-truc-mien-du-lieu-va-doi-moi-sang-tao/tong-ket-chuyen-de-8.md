...
* Kiến trúc miền dữ liệu là cấu trúc ngữ nghĩa của dữ liệu quốc gia, kết nối giữa kỹ thuật và tri thức.
* Ontology + Từ điển dữ liệu = nền móng cho dữ liệu hiểu biết và liên thông.
* Kiến trúc sư miền dữ liệu là nhân tố chủ chốt để dữ liệu công trở thành nguồn lực đổi mới sáng tạo.
* Sandbox dữ liệu là công cụ giúp Chính phủ chuyển từ quản lý dữ liệu sang khai thác dữ liệu để đổi mới chính sách.

✅ **Tóm lược triết lý chuyên đề:**

> “Kiến trúc miền dữ liệu chính là nơi dữ liệu trở thành tri thức, tri thức trở thành đổi mới, và đổi mới tạo ra giá trị công cho xã hội.”
